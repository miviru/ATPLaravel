...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-1">
                <a class="btn btn-outline-danger text-white" href="{{ route('descargar', ['id' => $tenista->id]) }}">
            ...
            <div class="col-md-1">
                <a class="btn btn-outline-secondary text-white" href="{{ route('tenistas.index') }}">Volver</a>
            </div>
        </div>
    </div>
